...
parameter choices.  The residual ratio 1.06 is small compared with the
assigned Type-B uncertainty scales of the inputs that were varied to
produce it, but this remains a **sensitivity demonstration**, not a
formal statistical reconciliation: `κ_PS` is a discrete
literature/model-choice systematic, not a Gaussian random variable, and
the radius shift is at the magnitude of the manufacturer tolerance.  No
new physical mechanism has been invoked at the present uncertainty level.
