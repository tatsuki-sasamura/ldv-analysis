...
- [x] ~~**Step B**: Voltage sweep — 5, 10, 15, 20, 25 Vpp at 1.907 MHz~~ — done (test10, `voltage_sweep.py`). 25 Vpp blocked by burst detection bug; 5–20 Vpp processed. p₀_1f linear in V, p₀_2f quadratic in V² as expected from Coppens scaling.
